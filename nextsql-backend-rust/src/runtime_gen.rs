/// Generate the content for the runtime.rs file that gets embedded into
/// the user's generated code. Contains only backend-agnostic traits and types.
/// Backend-specific implementations (e.g. tokio-postgres, sqlx) are provided
/// by the `nextsql-backend-rust-runtime` crate or the user's own code.
pub fn generate_runtime() -> String {
    String::from(r#"// AUTO-GENERATED by nextsql. Do not edit.
...
///
/// This trait is backend-agnostic: implementations can be provided for
/// PostgreSQL, MySQL, SQLite, or any other database.
